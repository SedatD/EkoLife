...
public class FragmentDoganlarOne extends Fragment {
    ...
    private void getRequest(final String autoId) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://ekolife.vodasoft.com.tr/api/General/GetBirthDays?req=1", new Response.Listener<String>() {
            @Override
