 ...
 * :)
 */
public class FragmentDoganlarTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_doganlar_two, container, false);
    ...
    private void getRequest(final String autoId) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://ekolife.vodasoft.com.tr/api/General/GetBirthDays?req=2", new Response.Listener<String>() {
            @Override
